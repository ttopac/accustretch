...
if __name__ == "__main__":
  ...
  a1 = ellipse1["a"] * 0.75 #For inner we multiply the major and minor axes by 0.75
  b1 = ellipse1["b"] * 0.75 #For inner we multiply the major and minor axes by 0.75
  x01 = ellipse1["x0"]
  y01 = ellipse1["y0"]
  theta1 = ellipse1["theta"]
  a2 = ellipse2["a"] * 0.75 #For inner we multiply the major and minor axes by 0.75
  b2 = ellipse2["b"] * 0.75 #For inner we multiply the major and minor axes by 0.75
  x02 = ellipse2["x0"]
  y02 = ellipse2["y0"]
  ...
  with open("inner_ellipse_dist.txt", "w") as fo:
