    ...
    mytuple = tuple (edges_list)
    p.seedEdgeByNumber(edges=mytuple, number=32, constraint=FINER)
    pickedEdges = e.getClosest (coordinates=(($PNT_6_1_XCOORD_edge$, 0, $PNT_6_1_ZCOORD_edge$), ($PNT_6_2_XCOORD_edge$, 0, $PNT_6_2_ZCOORD_edge$), ($PNT_6_3_XCOORD_edge$, 0, $PNT_6_3_ZCOORD_edge$), ($PNT_6_4_XCOORD_edge$, 0, $PNT_6_4_ZCOORD_edge$), ))
    edges_list = []
    for item in pickedEdges.values():
        edges_list.append(item[0])
    mytuple = tuple (edges_list)
    ...
    mytuple = tuple (edges_list)
    p.seedEdgeByNumber(edges=mytuple, number=32, constraint=FINER)
    distToSym_1 = $PNT_MID_1_XCOORD$ - $PNT_6_1_XCOORD_edge$
    distToSym_2 = $PNT_MID_1_XCOORD$ - $PNT_6_2_XCOORD_edge$
    distToSym_3 = $PNT_MID_1_XCOORD$ - $PNT_6_3_XCOORD_edge$
    distToSym_4 = $PNT_MID_1_XCOORD$ - $PNT_6_4_XCOORD_edge$
    pickedEdges = e.getClosest (coordinates=(($PNT_6_1_XCOORD_edge$ + 2*distToSym_1, 0, $PNT_6_1_ZCOORD_edge$), ($PNT_6_2_XCOORD_edge$ + 2*distToSym_2, 0, $PNT_6_2_ZCOORD_edge$), ($PNT_6_3_XCOORD_edge$ + 2*distToSym_3, 0, $PNT_6_3_ZCOORD_edge$), ($PNT_6_4_XCOORD_edge$ + 2*distToSym_4, 0, $PNT_6_4_ZCOORD_edge$), ))
    edges_list = []
    for item in pickedEdges.values():
        edges_list.append(item[0])
    mytuple = tuple (edges_list)
